...
def depth_callback(msg):
    return bridge.imgmsg_to_cv2(msg, "32FC1")
...
def move_to_coords(vsTargets, move):
    ...
    rec = rectification(vsTargets.orientation.x, vsTargets.orientation.y, vsTargets.orientation.z, vsTargets.orientation.w)
...
def outlierRemoval(pcd, securityFactor, mode):
